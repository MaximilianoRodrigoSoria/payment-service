package com.ar.laboratory.paymentservice.shared.infrastructure.metrics;
...
public class UseCaseMetricsAspect {
     ...
     */
    @Around(
            "execution(* com.ar.laboratory.paymentservice..application.inbound.command..*(..))"
                    + " && !within(com.ar.laboratory.paymentservice..infrastructure..*)")
